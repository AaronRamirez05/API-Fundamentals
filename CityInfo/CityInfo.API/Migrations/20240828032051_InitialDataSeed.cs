        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 1, "The most visited urban park in the United States.", "Empire State Building" },
                    { 3, 2, "A Gothic style cathedral.", "Cethedral" },
                    { 4, 3, "The finest example of railway architecture in Belgium.", "Antwerp Central Station" },
